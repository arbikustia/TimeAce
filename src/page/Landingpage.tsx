  ...
  return (
    <div className="bg-white">
      ...
      <div className="w-full h-screen flex flex-col justify-center items-center">
        ...
        <h1 className="text-5xl font-extrabold text-blue-500 z-10 absolute top-20 ">
          TimeAce
        </h1>
        ...
        <img
          src={shape3}
          className="px-5 md:w-1/3 mt-10 z-10 absolute bottom-0"
          alt=""
        />
        <img
          src={shape2}
          className=" md:w-1/5  absolute right-0 top-16"
          alt=""
        />
      </div>
      <HeroRight
      ...
      <footer className="footer footer-center p-10 bg-blue-500 text-primary-content">
        <div>
          <img className="w-10" src={logo2} alt="logo" />
